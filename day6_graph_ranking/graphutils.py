...
def adjacent_cooccurrence_graph(sents, tokenizer, vocab_to_idx, window=1, verbose=False):
    """
    :param sents: list of str
        Sentences
    :param tokenizer: callable
...
def sents_to_adjacent_graph(sents, tokenizer=lambda s:s.split(),
    min_count=2, min_cooccurrence=1, window=1, verbose=False):
    """
    :param sents: list of str
        Sentences
    :param tokenizer: callable
    ...
    C = adjacent_cooccurrence_graph(sents, tokenizer, vocab_to_idx, window, verbose)
